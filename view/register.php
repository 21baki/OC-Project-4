                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password1"  value="<?php echo htmlspecialchars($password);?>" class="form-control" required/>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="confirm" id="confirm"  value="<?php echo htmlspecialchars($confirm);?>" class="form-control" required/>
